...
import { useSendResumeMutation, useUpdateResumeMutation } from "../../services/resumeApi";
      ...
      >
        <Box width="50%">
          ...
          >
            ...
            <Divider component="div" sx={{ marginTop: 2, borderBottomWidth: 2 }} />
          </Box>
          ...
          <Box
            ...
            >
              ...
              <TextField
                ...
                value={phone_number}
                onChange={(e) => dispatch(setField({ field: "phone_number", value: e.target.value }))}
                required
                fullWidth
                name="phone_number"
            ...
            >
              ...
              <TextField
                ...
                value={metro_station}
                onChange={(e) => dispatch(setField({ field: "metro_station", value: e.target.value }))}
                required
                fullWidth
                name="metro_station"
            ...
            >
              ...
              <TextField
                ...
                value={military_duty}
                onChange={(e) => dispatch(setField({ field: "military_duty", value: e.target.value }))}
                required
                fullWidth
                name="military_duty"
            ...
            <Box
              margin={3}
            >
              <Typography variant="h5">Расскажите про ваш опыт работы: </Typography>
              <AutoresizeTextarea
                value={busyness}
                onChange={(e) => dispatch(setField({ field: "busyness", value: e.target.value }))}
                required
                minRows={3}
                name="busyness"
            ...
            <Box
              margin={3}
            >
              <Typography variant="h5">Опишите в 2-3 предложениях, почему Вы хотите работать в нашей
                компании: </Typography>
              <AutoresizeTextarea
                value={reasons_for_working}
                onChange={(e) => dispatch(setField({ field: "reasons_for_working", value: e.target.value }))}
                required
                minRows={3}
            ...
            <Box
              margin={3}
            >
              <Typography variant="h5">Компьютерные программы для автоматизированного проектирования, которвыми Вы
                владеете. Также оцените степень владения ими от 1 до 10 баллов. </Typography>
              <AutoresizeTextarea
                required
                value={good_job_qualities}
                onChange={(e) => dispatch(setField({ field: "good_job_qualities", value: e.target.value }))}
                minRows={3}
            ...
            <Box
              margin={3}
            >
              <Typography variant="h5">Расскажите про свои положительные личные качества (2-3
                предложения): </Typography>
              <AutoresizeTextarea
                required
                value={good_qualities}
                onChange={(e) => dispatch(setField({ field: "good_qualities", value: e.target.value }))}
                minRows={3}
                name="good_qualities"
            ...
            <Box
              margin={3}
            >
              <Typography variant="h5">Расскажите про свои отрицательные личные качества (2-3
                предложения): </Typography>
              <AutoresizeTextarea
                value={bad_qualities}
                onChange={(e) => dispatch(setField({ field: "bad_qualities", value: e.target.value }))}
                required
                minRows={3}
                name="bad_qualities"
            ...
            <Box
              margin={3}
            >
              <Typography variant="h5">Расскажите про свои вредные привычки (2-3 предложения): </Typography>
              <AutoresizeTextarea
                value={bad_habits}
                onChange={(e) => dispatch(setField({ field: "bad_habits", value: e.target.value }))}
                required
                minRows={3}
                name="bad_habits"
            ...
            <Box
              margin={3}
            >
              <Typography variant="h5">Прикрепите ссылку на резюме с hh.ru: </Typography>
              <TextField
                sx={{
                  mt: "12px"
                }}
                value={resume_src}
                onChange={(e) => dispatch(setField({ field: "resume_src", value: e.target.value }))}
                required
                fullWidth
                name="resume_src"
